...
public class BuyDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder b = new AlertDialog.Builder(getActivity())
                .setTitle("buy " + stock.getCompany().getName())
                .setPositiveButton("Confirm",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                new ExcuteNetwork().execute();
                                //Toast.makeText(getActivity(), "you bought with :" + roundTwoDecimals(total_value), Toast.LENGTH_SHORT).show();
                            }
                        }
                )
        ...
        View v = i.inflate(R.layout.activity_buy_dialog_fragment,null);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                total_value = curr_value * mProgress;
            }
        ...
        protected JSONObject doInBackground(Void... params) {
            ...
            try {
                ...
                object.put("no_stocks",mProgress);
                 buy_Request= Utils.buyStockRequest(object);
